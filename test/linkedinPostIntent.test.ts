...
test('buildLinkedInPostSearchQuery generates query from LinkedIn handle', () => {
  ...
  assert.strictEqual(buildLinkedInPostSearchQuery(lead), 'site:linkedin.com ("lewismcguinness" OR "in/lewismcguinness") (posts OR "recent-activity" OR hiring OR looking OR scaling)');
});
...
test('buildLinkedInPostSearchQuery falls back to name + company if no handle', () => {
  ...
  assert.strictEqual(buildLinkedInPostSearchQuery(lead), '"Dominic S" "Apex Tech" site:linkedin.com (posts OR "recent-activity" OR hiring OR looking OR scaling)');
});
...
test('buildLinkedInPostSearchQuery falls back to name only if company is missing', () => {
  ...
  assert.strictEqual(buildLinkedInPostSearchQuery(lead), '"Dominic S" site:linkedin.com (posts OR "recent-activity" OR hiring OR looking OR scaling)');
});
